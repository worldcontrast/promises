...
**WorldContrast Operations:**
WorldContrast operates under the public interest exception provided by **GDPR Article 85, Recital 153**. Data relates exclusively to public figures acting in their public capacity as political candidates, as permitted under **GDPR Article 9(2)(e)** — data manifestly made public by the data subject themselves in official electoral filings. Under the **LGPD (Brazil)**, data is processed based on Legitimate Interest (Art. 7º, IX) recognizing the public interest in electoral transparency. 

**API Users:**
Users of this API must comply with all applicable data protection laws,
including but not limited to GDPR and LGPD. WorldContrast does not
guarantee legal compliance for third-party implementations. Each user
is responsible for their own legal context.
